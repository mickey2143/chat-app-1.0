  ...
  return (
    <div className="w-full mb-20 h-full">
      <p>
        ...
        reiciendis quam voluptate, commodi rerum eveniet labore, minus molestias
        incidunt illum exercitationem sapiente. Tenetur officiis dicta, itaque
        repellendus temporibus ratione.
      </p>
    </div>
  );
}
